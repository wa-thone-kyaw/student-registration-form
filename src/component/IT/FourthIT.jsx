...
import "./IT.css";
import data from "./ITfourthmock-data.json";
import ITReadOnlyRow from "./ITReadOnlyRow";
import ITEditableRow from "./ITEditableRow";

export const FourthIT = () => {
