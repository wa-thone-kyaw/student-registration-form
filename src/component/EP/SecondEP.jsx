...
import "./EP.css";
import data from "./EPsecondmock-data.json";
import EPReadOnlyRow from "./EPReadOnlyRow";
import EPEditableRow from "./EPEditableRow";

export const SecondEP = () => {
