...
import "./MP.css";
import data from "./MPfourthmock-data.json";
import MPReadOnlyRow from "./MPReadOnlyRow";
import MPEditableRow from "./MPEditableRow";

export const FourthMP = () => {
